...
int main(int argc, char** argv) {
    ...
    dmls_gen.generate_dmls(sequence, atoi(argv[1]), 0, [](std::vector<bool>& sequence, uint8_t word_length) {
        ...
        file_name << "dmls_" << (int) word_length << "_" << sequence.size() << "_" << std::hex << sequence_hash
                  << ".yaml";
