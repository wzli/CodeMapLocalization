...
int test_bitwise_utils() {
    ...
    test_assert(sum_bits_64(~0ull) == 64);
    test_assert(sum_bits_64(0xf0f0f0f000000000) == 16);
    ...
    test_assert(first_set_bit_64(0ull) == 64);
    test_assert(first_set_bit_64(1ull << 40) == 40);
    test_assert(first_set_bit_64(0xf0f0f0f000000000) == 36);
